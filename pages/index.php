...
if (isset($_POST["copy_modules_to_database"])) {
    ...
    $rexModulesPath = 'rex_modules';
    $subPath = 'work';
    $directory = rex_path::addon('redaxo_bootstrap', '/' . $rexModulesPath . '/' . $subPath . '/');
    $module_paths = glob($directory . "*.json");
    $modulesFromDB = getModulesFromDB('redaxo_bootstrap');
    $index = 0;
    $messagesInfo = array();
    ...
    foreach ($module_paths as $module_path) {
        ...
        if (
            ...
            $module['createuser'] = 'redaxo_bootstrap';
...
if (isset($_POST["delete_modules_from_database"])) {
    $modules = getModulesFromDB('redaxo_bootstrap');
